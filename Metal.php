...
echo "<script>alert('wait for Acceptance');
		...
		echo "<script>window.location='Metal.php';</script>";
    ...
    min-height: 170px;" class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 style="background-color:#111 " class="page-title">Metal Reqest</h1>               
                    </div>
                </div>
            </div>
        </div>
...
<!-- FORM -->
  ...
  <h2 style="margin-left:280px; letter-spacing:6px;margin-top:10px; ">Reqest For Metal  </h2>
